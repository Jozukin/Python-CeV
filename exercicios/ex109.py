...
if op in 'Aa':
    print(f'O valor {fmoeda(valor)} com o aumento de {porc}% é {aumentar(valor, porc, formatar=True)}')
elif op in 'Rr':
    print(f'O valor {fmoeda(valor)} com a redução de {porc}% é {reduzir(valor, porc, formatar=True)}')
